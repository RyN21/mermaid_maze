class Crab
  ...
  def at_tile_center?(threshold = 12)
...
#
#   def move_left
#     if is_valid_move(@x - @speed -12, @y + 15)
#       update_animation
#       @x -= @speed
#     else
...
#
#   def move_up
#     if is_valid_move(@x - 10, @y - @speed - 7)
#       update_animation
#       @y -= @speed
#     else
#       change_direction(:up)
...
#
#   def move_dow
#     if is_valid_move(@x - 10, @y + @speed + 20)
#       update_animation
#       @y += @speed
#     else
...
#     index = rand(0..3)
#     @current_direction = @directions[index] if @current_direction != current_direction
#   end
#
#   def update_animation
#     @frame_counter += 1
